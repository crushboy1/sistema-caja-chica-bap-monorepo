...
const masterStatusConfig = new Map([
    ...
    ['repuesto', { theme: 'cyan', icon: 'M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z' }],
    ...
    ['pendiente re-evaluacion',{theme: 'revocacion', icon:'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'}],
    ...
    ['excepción otorgada', { theme: 'autorizacion', icon: 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z' }],
    ['excepción revocada', { theme: 'revocacion', icon: 'M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z' }],
